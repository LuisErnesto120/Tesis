...
\begin{itemize}
    ...
    Se pueden distinguir tres tipos de material antiferromagnético (AFM), según su ordenamiento espacial.
    \begin{figure}[H]
        \centering
...
Las ortoferritas \ce{RFeO3} presentan un comportamiento antiferromagnético a temperatura ambiente, con un ferromagnetismo débil inducido por la interacción de Dzyaloshinskii-Moriya \cite{KamalWarshi2018}.
