...
Se tienen en esta figura dos rayos, uno compuesto por los segmentos $\overline{XK}$ y $\overline{KY}$, y otro compuesto por los segmentos $\overline{XN}$, $\overline{MN}$, $\overline{LN}$ y $\overline{NY}$, como se muestra en la figura \ref{fig:braggdiag}.
